                ...
                <form action="{{route('admin.delivery-man.update',[$delivery_man['id']])}}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">Break</label>
                               <select  class="form-control" name="break">
                                   {{-- <option value="{{$delivery_man['break']}}">{{$delivery_man->break}}</option> --}}
                                   @if($delivery_man->break == 1)
                                    <option value="{{$delivery_man['break']}}"> Paid_Break</option>
                                    @else
                                     <option value="{{$delivery_man['break']}}"> Unpaid_Break</option>
                                     @endif
                                       <option value="1">Paid_Break</option>
                                         <option value="2"> Unpaid_Break</option>
                               </select>
                            </div>
                        </div>
                      <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="phone">Start-Shift</label>
                                <div class="input-group">
                                    <input type="time"  value="{{$delivery_man['start_shift']}}" name="start-shift" id="phone" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="phon"> End-Shift</label>
                                <div class="input-group">
                                      <input type="time"  value="{{$delivery_man['end_shift']}}" name="end-shift" id="phone" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                      <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="phone">Start service</label>
                                <div class="input-group">
                                    <input type="date" name="start_service"  value="{{$delivery_man['start_service']}}" id="phone" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="phon"> Finish Service</label>
                                <div class="input-group">
                                    <button type="button" onclick="apperElements('finishServiceElement')" id="phone" class="btn btn-primary">  Click to Finish Service </button>
                                </div>
                            </div>
                        </div>
                    </div>
                        <div class="row" style="display: none" id="finishServiceElement">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label"  for="phone">Reason for resignation</label>
                                <div class="input-group">
                                    <input type="text" name="reason" id="phone" class="form-control"  value="{{$delivery_man['reason']}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">End service</label>
                                <input type="date" name="end_service" class="form-control"  value="{{$delivery_man['end_service']}}"
                                    >
                            </div>
                        </div></div>
                    <hr>
