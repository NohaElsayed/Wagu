                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="time" name="start_shift" id="phone" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                      <input type="time" name="end_shift" id="phone" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                      <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="date" name="start_service" id="phone" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <button type="button"  id="phone" class="btn btn-primary">  Click to Finish Service </button>
                                </div>
                            </div>
                        </div>
                    </div> --}}
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="reason" id="phone" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="date" name="end_service" class="form-control"
                                    >
                            </div>
                        </div></div> --}}
                         {{-- <div class="row">
                          <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="phon">  Break</label>
                                <div class="input-group">
