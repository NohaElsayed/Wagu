...
@section('title',__('Add Zone Point'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header" style="border-bottom:0;padding-bottom:0;">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{__('messages.add')}} {{__('messages.new')}} {{__('Zone Point')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.delivery-man.openpoint')}}" method="post" enctype="multipart/form-data" class="js-validate">
                    @csrf

                    <small class="nav-subtitle text-secondary border-bottom">{{__('messages.restaurant')}} {{__('messages.info')}}</small>
                    <br>
                    <input type="hidden" value="[$dm['id']]">
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="phone">Start chift</label>
                                <div class="input-group">
                                    <input type="time" name="start_Shift" id="phone" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">End chift</label>
                     ...
                     <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">Chift Status</label>
                               <select  class="form-control" name="break">
                                   <option>Ready to receive the order</option>
                                   <option value="1"> Ready</option>
                                     <option value="2"> Start Work</option>
                                    <option value="1"> Paid break</option>
                                     <option value="2"> unpaid break</option>
                                     <option value="3"> wait</option>
                                     <option value="4"> finish work</option>
                               </select>
                            </div>
                        </div></div>
