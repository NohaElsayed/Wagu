                     ...
                     <div class="col-md-6 col-12">
                            <div class="form-group">
                               ...
                               <select  class="form-control" name="break">
                                    <option value="1"> Paid break</option>
                                     <option value="2"> unpaid break</option>
                               </select>
                            </div>
                        </div>
                    <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <button type="button" onclick="apperElements('finishServiceElement')" id="ddlModels" class="btn btn-primary" >  Click to Finish Service </button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="display: none" id="finishServiceElement">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="reason" id="txtOther" class="form-control"  value="{{$delivery_man['reason']}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="date" name="end_service" class="form-control" id="txtOther"  value="{{$delivery_man['end_service']}}"
                                    >
                            </div>
                        </div>
                    </div>
