        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('vendor.addorder.discount')}}" method="post" class="row">
                        @csrf
    ...
    <div class="modal fade" id="add-tax" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('vendor.addorder.tax')}}" method="POST" class="row" id="order_submit_form">
                        @csrf
    ...
    <div class="modal fade" id="paymentModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('vendor.addorder.order')}}" id='order_place' method="post" class="row">
                        @csrf
