...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.', 'middleware' => ['module:order']], function () {
           ...
           // Route::resource('orderadd', Order::class);
        ...
        Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.'], function () {
            ...
            Route::group(['middleware' => ['module:deliveryman']], function () {
                ...
                Route::get('shifts', [HistoryController::class,'shift'])->name('shifts');
                // Route::get('openpoint-view', [OpenpointController::class,'index'])->name('viewopenpoint');
                // Route::get('editeopenpoint', [OpenpointController::class,'edit'])->name('editopenpoint');
