...
use App\Http\Controllers\Vendor\AddOrder;
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        Route::group(['prefix' => 'addorder', 'as' => 'addorder.' , 'middleware' => ['module:order']], function () {
         Route::post('variant_price', 'AddOrder@variant_price')->name('variant_price');
        Route::get('add-order', [AddOrder::class,'index'])->name('add_order');
        Route::get('quick-view', 'AddOrder@quick_view')->name('quick-view');
        Route::get('quick-view-cart-item', 'AddOrderr@quick_view_card_item')->name('quick-view-cart-item');
        Route::post('add-to-cart', 'AddOrder@addToCart')->name('add-to-cart');
        Route::post('remove-from-cart', 'AddOrder@removeFromCart')->name('remove-from-cart');
        Route::post('cart-items', 'AddOrder@cart_items')->name('cart_items');
        Route::post('update-quantity', 'AddOrderr@updateQuantity')->name('updateQuantity');
        Route::post('empty-cart', 'AddOrder@emptyCart')->name('emptyCart');
        Route::post('tax', 'POSController@update_tax')->name('tax');
        Route::post('discount', 'POSController@update_discount')->name('discount');
        Route::get('customers', 'AddOrder@get_customers')->name('customers');
        Route::post('order', 'AddOrder@place_order')->name('order');
         });
