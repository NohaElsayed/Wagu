...
class AddOrder extends Controller
{
    public function index(Request $request)
    {
        ...
        ->latest()->paginate(10);
        return view('vendor-views.order.index', compact('categories', 'products','category', 'keyword'));
    }
    ...
    public function quick_view(Request $request)
    {
        ...
        return response()->json([
            'success' => 1,
            'view' => view('vendor-views.order._quick-view-data', compact('product'))->render(),
        ]);
    }
    ...
    public function quick_view_card_item(Request $request)
    {
        ...
        return response()->json([
            'success' => 1,
            'view' => view('vendor-views.order._quick-view-cart-item', compact('product', 'cart_item', 'item_key'))->render(),
        ]);
    }
    ...
    {
        return view('vendor-views.order._cart');
    }
    ...
    public function order_list()
    {
        ...
        return view('vendor-views.order.order.list', compact('orders'));
    }
    ...
    public function search(Request $request){
        ...
        return response()->json([
            'view'=>view('vendor-views.order.order.partials._table',compact('orders'))->render()
        ]);
    }
    ...
    public function order_details($id)
    {
        ...
        if (isset($order)) {
            return view('vendor-views.order.order.order-view', compact('order'));
        } else {
