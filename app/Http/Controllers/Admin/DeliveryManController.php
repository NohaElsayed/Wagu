...
class DeliveryManController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $dm->image = $image_name;
        $dm->end_service = $request->end_service;
        $dm->start_service = $request->start_service;
        $dm->end_shift = $request->end_shift;
        $dm->start_shift = $request->start_shift;
        $dm->active = 0;
    ...
    public function update(Request $request, $id)
    {
        ...
        $delivery_man->end_service = $request->end_service;
        $delivery_man->start_service = $request->start_service;
        $delivery_man->email = $request->email;
        $delivery_man->phone = $request->phone;
        $delivery_man->break = $request->break;
        ...
        $delivery_man->end_shift = $request->end_shift;
        $delivery_man->start_shift = $request->start_shift;
        $delivery_man->reason = $request->reason;
